...
def array_matched_filter(sample, template, psd, N, kmin, kmax, duration, delta_t=1.0/2048, flow=30):
    ...
    with tf.device("/GPU:0"):
        ...
        sample_template_correlated = tf.math.divide(
        ...
        sample_template_correlated = tf.pad(
            sample_template_correlated, #sample_template_correlated_rescaled,
            paddings, 
            "CONSTANT"
        )
        ...
        sample_template_correlated = tf.signal.ifft(sample_template_correlated)
